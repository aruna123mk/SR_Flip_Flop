SR flip flop is also the storage element which can store the single data it may be either 1 or 0 .The block diagram of the SR flip flop is shown below with its truth table and wave forms.
